...
const EUEEYearClientPage = () => {

  const searchParam = useSearchParams();
  const searchQueryData = searchParam?.get("right");
  
  const [feedbackVisible, setFeedbackVisible] = useState(searchQueryData?searchQueryData:false);
...
export default EUEEYearClientPage 