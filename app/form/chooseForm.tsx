...
const ChooseForm:React.FC<ChooseFormProps> = ({onChange,label,onAnswer}) => {
  ...
  " ></textarea>
    <div className="flex items-center gap-1 ">
      <input checked={true} onChange={onAnswer} id="default-radio-1" type="radio"  name="default-radio" className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
